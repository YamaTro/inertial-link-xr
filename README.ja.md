...
v0.1の目的は、相互運用性と安全な異常時動作を検証することです。有効性を示す段階ではありません。APIや通信仕様のマイナーバージョンは変更される可能性があります。検証済み範囲と未検証事項は[検証記録（英語）](docs/VALIDATION.md)、予定は[ロードマップ](ROADMAP.md)で公開します。
